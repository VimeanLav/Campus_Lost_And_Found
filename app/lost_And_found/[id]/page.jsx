...
export default function LostItemDetail() {
  ...
  return (
    <div className="max-w-xl mx-auto p-8 border rounded-xl mt-10">
      <img src={item.imageUrl || '/watch.png'} alt="item" className="w-full h-[300px] object-contain mb-6" />
      ...
      <button onClick={handleRequest} className="mt-8 w-full bg-blue-600 text-white py-3 rounded-md hover:opacity-90 transition">Request Item</button>
    </div>
  );
}
